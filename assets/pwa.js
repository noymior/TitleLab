(function () {
  ...
  const registerServiceWorker = () => {
    navigator.serviceWorker
      ...
      .then(reg => {
        console.info(`[PWA ${BUILD_TAG}] Service Worker registered:`, reg.scope);
      })
      .catch(err => {
        console.error(`[PWA ${BUILD_TAG}] Service Worker registration failed:`, err);
      });
  };
